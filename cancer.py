...
def main():
    ...
    mean_concave_points = st.sidebar.number_input(" Mean Concave Points", value=0.05, min_value=0.0, max_value=0.4)
    ...
    concave_points_error = st.sidebar.number_input(" Concave Points Error", value=0.02, min_value=0.005, max_value=0.2)
    ...
    st.sidebar.markdown("###  Worst Cell Features")
    ...
    worst_concave_points = st.sidebar.number_input(" Worst Concave Points", value=0.1, min_value=0.0, max_value=0.5)
